...
def main():
    ...
    print(
        "Inıtial Macro-Avg  F-1 for Random Forest on Test data: ",
        initial_report_dict["macro avg"]["f1-score"],
    )
    CV_rfc = GridSearchCV(estimator=rfc, param_grid=rf_param_grid, cv=5, scoring="f1_macro")
    ...
    print(
        "Tuned Macro-Avg  F-1 for Random Forest on Test data: ",
    ...
    jsonpath = conf["results_dir"] / "RandomForest_Best_Params.json"
